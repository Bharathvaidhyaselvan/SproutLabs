...
export default function WhyChoose() {
  return (
    <section className="relative overflow-hidden bg-brand-lavender py-16 sm:py-20 md:py-24">
      <DecorativeElement
        type="blob2"
        className="pointer-events-none -left-20 -top-20 hidden h-[400px] w-[400px] text-white/50 sm:block md:h-[600px] md:w-[600px]"
      />
          ...
          <div className="order-2 lg:order-1 relative">
            ...
            >
              ...
              <div className="absolute inset-0 -rotate-3 overflow-hidden rounded-[40px] border-8 border-brand-cream bg-white md:rounded-full">
                <img
                  src={CENTRAL_IMAGE}
                  alt="Students collaborating on a project during a hands-on learning session"
              ...
              >
                <div className="w-10 h-10 rounded-full bg-brand-yellow/20 flex items-center justify-center text-xl">
                  🏆
                </div>
              ...
              >
                <div className="w-10 h-10 rounded-full bg-brand-teal/20 flex items-center justify-center text-xl">
                  ⭐
                </div>
                <div className="font-bold text-brand-navy text-sm">
                  Expert Mentors
            ...
            <ul className="flex flex-col gap-6">
              {reasons.map((reason, index) => (
                ...
                >
                  ...
                  <span className="text-brand-navy/80 font-medium leading-relaxed">
                    {reason}
                  </span>
                </motion.li>
              ))}
