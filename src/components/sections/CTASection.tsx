  ...
  return (
    <section className="relative overflow-hidden bg-brand-teal pb-36 pt-32 text-center">
      ...
      <div className="relative z-10 mx-auto mt-16 max-w-4xl px-6 md:mt-20 md:px-12">
        ...
        >
          <h2 className="mb-6 font-heading text-4xl font-black leading-tight text-white md:text-5xl lg:text-6xl">
          ...
          <p className="mb-10 max-w-2xl text-lg leading-relaxed text-white/90 md:text-xl">
            We collaborate with schools, colleges, learning centres, principals, and academic leaders to integrate practical innovation and STEM learning into student journeys.
          </p>
